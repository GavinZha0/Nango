...
4. **Draft Contract**: Place your modifications in \`draftData\`. Send only the editable fields you wish to change conforming strictly to the Resource Draft Contracts below. Read-only fields in \`activeResourceData\` are for context only. Unknown or invalid fields will be rejected.
