...
4. **Domain Tool Priority**: Specialized agents equipped with dedicated server-side lifecycle tools (such as Tester Agent's suite/case management tools) should prioritize their role-specific tools for direct asset management.
