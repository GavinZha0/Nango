...
export interface EvalCaseListProps {
  ...
  onRequestEditCase?: (caseRow: EvalCaseRow) => void;
  onRequestDeleteCase?: (caseRow: EvalCaseRow) => void;
  loading: boolean;
  error: string | null;
  readOnly?: boolean;
}
        ...
        <div className="flex items-center gap-1">
          ...
          {onRunSuite && (
            <Button
              ...
              disabled={cases.length === 0 || isSuiteRunning}
              onClick={onRunSuite}
            >
              {isSuiteRunning ? (
