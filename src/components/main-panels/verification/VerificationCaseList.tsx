...
import { CaseVerdictBadge, CaseEnableToggle } from "@/components/main-panels/common";
...
export interface VerificationCaseListProps {
  suiteName?: string;
...
export function VerificationCaseList({
  cases,
  verdictByCaseId,
  selectedCaseId,
  onSelectCase,
  ...
  error,
  readOnly = false,
}: VerificationCaseListProps): ReactNode {
          ...
          {loading && cases.length === 0 ? (
            ...
            cases.map((c) => {
              ...
              return (
                ...
                >
                  {/* Left: Verdict Status Badge + Clickable Case Name */}
